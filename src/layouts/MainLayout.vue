<template>
  <div class="relative flex h-screen lg:static bg-surface-50 dark:bg-surface-950">
    ...
    >
      <div class="flex flex-col h-full">
        <div class="flex items-center justify-start px-4 py-4">
          <div class="mx-auto">
            <img
              src="../assets/learnfrontend-logo.svg"
              class="h-[75px] mx-auto w-[220px]"
            />
          </div>
        </div>
    ...
    <div
      class="flex flex-col flex-auto h-screen bg-surface-50 dark:bg-surface-950 p-7 md:p-8"
    >
      <div
