    ...
    >
      <div class="flex flex-col h-full">
        <div class="flex items-center justify-start px-4 py-4">
          <div class="mx-auto">
            <img src="../assets/learnfrontend-logo.svg" class="h-[75px] mx-auto w-[220px]" />
          </div>
        </div>
        <div class="flex flex-col flex-1 gap-4 p-2 overflow-y-auto">
          ...
          <ul class="flex flex-col gap-1 p-0 m-0 list-none">
            <li>
              ...
              >
                <span class="text-base font-semibold leading-tight">Roadmaps</span>
                <i
              ...
              <ul class="flex flex-col gap-1 p-0 m-0 overflow-hidden list-none">
                <li>
                  ...
                  >
                    ...
                    >
                      <i
                        class="pi pi-sparkles text-xs! leading-none! text-violet-600 dark:text-violet-300"
                      />
                    </span>
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      <i
                        class="pi pi-wrench text-xs! leading-none! text-amber-600 dark:text-amber-300"
                      />
                    </span>
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      <i
                        class="pi pi-palette text-xs! leading-none! text-lime-600 dark:text-lime-300"
                      />
                    </span>
