<template>
  <div class="flex justify-center h-screen px-12 py-20 bg-no-repeat bg-cover md:px-12 lg:px-20" style="
            background:
    ...
    <div class="flex flex-wrap my-auto">
      <div
        ...
        <div class="flex flex-col gap-2">
          <div class="text-2xl font-semibold leading-tight text-surface-900 dark:text-surface-0">Welcome to Bastion
          </div>
          <div class="leading-normal text-surface-900/60 dark:text-surface-0/60">Quis vel eros donec ac odio tempor orci
            dapibus. In hac habitasse platea dictumst quisque.</div>
        </div>
        <div class="flex flex-col gap-6">
          <div class="flex gap-4">
            ...
            <div class="flex flex-col flex-1 gap-2">
              ...
              <div class="leading-normal text-surface-900/60 dark:text-surface-0/60">Tincidunt nunc pulvinar sapien et.
                Vitae purus faucibus ornare suspendisse sed nisi lacus sed viverra.</div>
            </div>
          </div>
          <div class="flex gap-4">
            <div class="flex items-center justify-center rounded-lg h-9 w-9 bg-surface-900 dark:bg-surface-50">
            ...
            <div class="flex flex-col flex-1 gap-2">
              ...
              <div class="leading-normal text-surface-900/60 dark:text-surface-0/60">Scelerisque purus semper eget duis
                at tellus at urna. Sed risus pretium quam vulputate.</div>
            </div>
          </div>
          <div class="flex gap-4">
            <div class="flex items-center justify-center rounded-lg h-9 w-9 bg-surface-900 dark:bg-surface-50">
            ...
            <div class="flex flex-col flex-1 gap-2">
              ...
              <div class="leading-normal text-surface-900/60 dark:text-surface-0/60">Egestas sed tempus urna et. Auctor
                elit sed vulputate mi sit amet mauris commodo.</div>
            </div>
          </div>
        </div>
      </div>
      <div
        ...
        <div class="text-2xl font-medium leading-tight text-surface-900 dark:text-surface-0">Login</div>
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-6">
          ...
          <Button label="Sign In with GitHub" icon="pi pi-github text-base! leading-none!" severity="secondary"
            class="w-full" />
        </div>
        <div class="text-center">
          <span class="text-surface-600 dark:text-surface-300">Don't have an account? </span>
          <span class="font-medium cursor-pointer text-primary hover:text-primary-emphasis">Sign up</span>
        </div>
      </div>
    </div>
  </div>
